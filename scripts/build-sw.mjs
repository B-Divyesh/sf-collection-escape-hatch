...
const shell = ['/', '/index.html', '/demo/', '/demo/index.html', '/privacy/', '/privacy/index.html', '/terms/', '/terms/index.html', '/not-found.html', '/favicon.svg', '/apple-touch-icon.png', '/og-blueprint.png', ...assets];
